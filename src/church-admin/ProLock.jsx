...
const COPY = {
  reviews: ['Reply publicly to what members are saying', 'Thank them, answer what they raised, and say what you’re changing — your reply shows right under the review for every visitor who reads it.'],
  ...
  return (
    <div className="max-w-[640px] flex flex-col gap-4">
      <div className="flex items-center gap-[11px]" style={{ color: 'var(--color-accent-700)' }}>
        ...
        <span style={{ fontSize: 11, letterSpacing: '.08em', textTransform: 'uppercase' }}>Get-God Pro</span>
      </div>
