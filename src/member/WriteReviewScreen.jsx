...
export function WriteReviewScreen() {
  ...
  if (!slug) {
    return (
      <div className="pf-scroll pf-screen flex-1" style={{ padding: '0 0 8px' }}>
        <div className="px-5" style={{ position: 'sticky', top: 0, zIndex: 2, paddingTop: 24, paddingBottom: 8, background: 'var(--color-bg)' }}>
  ...
  return (
    <div className="pf-scroll pf-screen flex-1" style={{ padding: '0 0 8px' }}>
      <div className="flex items-center gap-[10px] border-b px-4" style={{ position: 'sticky', top: 0, zIndex: 2, paddingTop: 20, paddingBottom: 12, background: 'var(--color-bg)', borderColor: 'var(--color-divider)' }}>
